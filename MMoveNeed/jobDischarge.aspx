<%@ Page Title="" Language="C#" MasterPageFile="~/backadmin.Master" AutoEventWireup="true" CodeBehind="jobDischarge.aspx.cs" Inherits="MMoveNeed.jobDischarge" %>
        ...
        <asp:ListView ID="lstPTjob" runat="server" DataSourceID="SqlDataPTjob" OnItemCommand="PTJobListView_OnItemCommand">
            ...
            <ItemTemplate>
                ...
                <div style="width:600px;height:20px;margin-bottom:20px;margin-top:5px;">
                    ...
                    <asp:Button runat="server" ID="btnApprove" Width="60" Height="20" Text="下架"  OnClick="btnDischarge_Click" CommandName="UpdateJobStatusToOld"/>
                </div>
            </ItemTemplate>
        </asp:ListView>
        <asp:SqlDataSource ID="SqlDataPTjob" runat="server" ConnectionString="<%$ ConnectionStrings:MMoveNeedDataConnectionString %>" SelectCommand="SELECT [uid], [username], [jobID], [jobName], [employerName], [jobDetails], [employeeCount], [jobAbstract], [salary], [workTime], [phoneNumber], [address], [jobApplyTime], [jobPublishTime], [approveStatus] FROM [jobData]">
        </asp:SqlDataSource>
    </div>
</asp:Content>
