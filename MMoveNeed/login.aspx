<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="MMoveNeed.login" %>
    ...
    <div>
        <form runat="server">
           <%-- <p><label>用户名：</label><input type="text" name="username"/></p>
            ...
            <p><asp:Label runat="server" Text="用户名："></asp:Label><asp:TextBox runat="server" ID="username" MaxLength="15"></asp:TextBox>
            ...
            <p><asp:Label runat="server" Text="密码："></asp:Label><asp:TextBox runat="server" ID="password" TextMode="Password" MaxLength="15"></asp:TextBox>
