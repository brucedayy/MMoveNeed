<%@ Page Title="" Language="C#" MasterPageFile="~/backadmin.Master" AutoEventWireup="true" CodeBehind="jobDataAdmin.aspx.cs" Inherits="MMoveNeed.jobDataAdmin" %>
        ...
        <asp:ListView ID="lstPTjob" runat="server" DataSourceID="SqlDataPTjob" OnItemCommand="PTJobListView_OnItemCommand">
            ...
            <ItemTemplate>
                ...
                <div style="width:600px;height:20px;margin-bottom:20px;margin-top:5px;">
                    ...
                    <asp:Button runat="server" ID="btnApprove" Width="60" Height="20" Text="批准"  OnClick="btnApprove_Click" CommandName="UpdateJobStatus"/>
                </div>
            </ItemTemplate>
        </asp:ListView>
        <asp:SqlDataSource ID="SqlDataPTjob" runat="server" ConnectionString="<%$ ConnectionStrings:MMoveNeedDataConnectionString %>" SelectCommand="SELECT [uid], [username], [jobID], [jobName], [employerName], [employeeCount], [jobDetails], [jobAbstract], [salary], [workTime], [phoneNumber], [address], [jobApplyTime], [jobPublishTime], [approveStatus] FROM [jobData] WHERE ([approveStatus] = @approveStatus)">
            <SelectParameters>
